  ...
  <body>
	<div class="layout-admin">
		<header class="layout-header">
			<span class="header-logo">Freight Management and Presentation System</span> 
			...
			<ul class="header-bar">
				...
				<li class="header-bar-nav"> 
					...
					<ul class="header-dropdown-menu right dropdown-skin">
						<li><a href="javascript:;" data-val="qingxin" title="清新">Fresh</a></li>
						<li><a href="javascript:;" data-val="blue" title="蓝色">Blue</a></li>
						<li><a href="javascript:;" data-val="molv" title="墨绿">Green</a></li>
			...
			<div class="layout-main-tab">
                ...
                <nav class="tab-nav">
                    <div class="tab-nav-content">
                        <a href="javascript:;" class="content-tab active" data-id="home.html">Homepage</a>
                    </div>
                </nav>
                <button class="tab-btn btn-right"><i class="icon-font">&#xe60f;</i></button>
			</div>
			<div class="layout-main-body">
				<iframe class="body-iframe" name="iframe0" width="100%" height="99%" src="home/home.jsp" frameborder="0" data-id="home.html" seamless></iframe>
			</div>
		</section>
		<div class="layout-footer">@2018 SPEC Team</div>
	</div>
